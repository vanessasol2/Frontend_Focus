        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full mt-1 border rounded-md p-2 text-sm ${
                errors.fechaSesion ? 'border-red-500' : 'border-gray-300'
              }`}
            />
            {errors.fechaSesion && (
              <p className="mt-1 text-sm text-red-500">{errors.fechaSesion}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              />
              {errors.horaInicio && (
                <p className="mt-1 text-sm text-red-500">{errors.horaInicio}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.horaFin && (
                <p className="mt-1 text-sm text-red-500">{errors.horaFin}</p>
              )}
            </div>
          </div>
